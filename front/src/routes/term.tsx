    ...
    <div className="container mx-auto max-w-4xl px-4 py-12">
      ...
      <main className="rounded-lg bg-white p-8 shadow-md sm:p-12">
        <p className="mb-8 text-gray-600">
          この利用規約（以下、「本規約」といいます。）は、「すごい開発者」（以下、「当方」といいます。）がこのウェブサイト上で提供するサービス「HackMeet」（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に従って、本サービスをご利用いただきます。
        </p>

        <article className="mb-10">
          <h2 className="mb-4 border-b-2 border-gray-200 pb-2 text-2xl font-bold">
            第1条（適用）
          </h2>
        ...
        <article className="mb-10">
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              1.
              ユーザーは、自己の責任において、本サービスのユーザー情報をを適切に管理するものとします。
            </p>
            <p>
              2.
              ユーザーは、いかなる場合にも、ユーザー情報を第三者に譲渡または貸与し、もしくは第三者と共用することはできません。
            </p>
          </div>
        </article>
        ...
        <article className="mb-10">
          ...
          <ol className="list-inside list-decimal space-y-2 pl-4 text-gray-700">
        ...
        <article className="mb-10">
          ...
          <div className="space-y-4 text-gray-700">
            <p>
              1.
              ユーザーが本サービスを利用して投稿その他送信した文章、画像、映像等の著作権については、当該ユーザーその他既存の権利者に留保されるものとします。ただし、当方は、本サービスを利用して投稿その他送信された文章、画像、映像等について、本サービスの提供、改善、プロモーションに必要な範囲内で利用できるものとし、ユーザーは、この利用に関して、著作者人格権を行使しないものとします。
            </p>
            <p>
              2.
